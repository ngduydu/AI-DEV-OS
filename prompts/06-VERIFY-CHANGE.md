...
2. Đọc `docs/01-development/commands.md` và `docs/01-development/testing.md`.
...
6. Báo PASS/FAIL/NOT VERIFIED cho từng check.
7. Kết luận không được mạnh hơn bằng chứng.
