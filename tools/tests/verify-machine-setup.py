...
def main() -> None:
    ...
    required = {
        ...
        "Headroom Windows autostart": "AI-DEV-OS-Headroom",
        "Headroom user Run key": "HKCU:\\Software\\Microsoft\\Windows\\CurrentVersion\\Run",
        "Headroom startup launcher": "start-headroom.ps1",
        "Headroom readiness": "http://127.0.0.1:8787/readyz",
        "Headroom cold-start ensure": "init hook ensure --profile init-user",
